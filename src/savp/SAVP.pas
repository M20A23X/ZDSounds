...
uses UnitMain, SysUtils, Math, Windows, Bass, inifiles, UnitDebug, ExtraUtils, SoundManager, Dialogs, Debug, bass_fx, IOUtils;
...
procedure Load_TWS_SAVP_EK();
begin
     if (FormMain.cbSAVPESounds.Checked = False) and (FormMain.cbEPL2TBlock.Checked = False) and (SAVPName <> '') then begin
       const infoFile: string = 'routes/' + Route + '/Info_Obj_' + naprav + '.txt';
